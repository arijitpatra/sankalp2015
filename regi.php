...
if ($flag && mysqli_query($conn, $sql)) {
    echo '<div id="response">Thank You for registering! See you at Sankalp 2015.<br>Registration ID: SNKLP0'. mysqli_insert_id($conn). '<br><br><br>Got some time?<br>Visit the Sankalp <a id="gallery-container" href="gallery.html" style="text-decoration:none;">Gallery</a></div>'; 
} 
else {
     echo '<div id="response">'.$msg.'<br><br><br>Got some time?<br>Visit the Sankalp <a id="gallery-container" href="#" style="text-decoration:none;">Gallery</a></div>'; 
}
